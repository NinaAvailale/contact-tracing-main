...
write.table(gamma_cases_sta,"data_processed/gammafit_secondary_cases_statistics_by_location.csv",row.names = FALSE,
            col.names = TRUE,sep = ",")
...
quan_r[,2]<-c(3.974,1.796,1.109,1.463,1.658)
